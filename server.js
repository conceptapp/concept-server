...
express()
  ...
  .get('/db', async (req, res) => {
  try {
    var myQuery = "INSERT INTO clients (socket_id, game_room_name, game_room_id) \
      VALUES  ( $1, $2, $3 )"
    var value = ['socket_id_02980973',  'La partie de Max',  'game_room_id_09898798']
    var myQuery = "INSERT INTO clients (socket_id, game_room_name, game_room_id) \
      VALUES  ( 'socket_id_02980973',  'La partie de Max',  'game_room_id_09898798' )"
    var value = ['socket_id_02980973',  'La partie de Max',  'game_room_id_09898798']
